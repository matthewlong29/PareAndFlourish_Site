...
<div class="row about-us">
    <div class="col-lg-4 col-sm-4">
        <img src="{{site.url}}/images/other/skylar.png" class="img-responsive">
    ...
    <div class="col-lg-4 col-sm-4">
        <img src="{{site.url}}/images/other/katie.png" class="img-responsive">
    ...
    <div class="col-lg-4 col-sm-4">
        <img src="{{site.url}}/images/other/matthew.png" class="img-responsive">
