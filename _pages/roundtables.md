...
image:
  header: roundtables.jpg
  teaser: pandf-roundtables.jpg
---
...
<div id="calendar">
  <div class="month january">
    ...
    <div class="month-content">
      <div class="month-details">
        ...
        <p><strong>Note</strong>: This roundtable is rescheduled to Feb 4th due to extreme weather.</p>
      </div>
  ...
  <div class="month june">
    ...
    <div class="month-content">
      <div class="month-details">
        ...
        <p><strong>Note</strong>: This roundtable has been moved to July 7th!</p>
      </div>
  ...
  <div class="month october">
    ...
    <div class="month-content">
      <div class="month-details">
        <p>No roundtable this month, but check out our <strong>Flourishing Females</strong> panel and workshop in November!!</p>
      </div>
    </div>
  </div>
  <div class="month november">
    ...
    <div class="month-content">
      <div class="month-details">
        <p><strong>Flourishing Females Panel + Workshop</strong></p>
        <p><strong>Location</strong>: Bowling Green, Ky</p>
        <p><strong>Date</strong>: November 10th</p>
      </div>
      <a href="/events/">
        <div class="sign-up">
          <span>Learn more!</span>
